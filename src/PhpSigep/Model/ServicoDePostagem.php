...
class ServicoDePostagem extends AbstractModel
{
    ...
    const SERVICE_SEDEX_REVERSO_CONTRATO_AGENCIA_TA = '04928';
    const SERVICE_PAC_REVERSO_CONTRATO_AGENCIA_TA = '04936';
...
//    const SERVICE_CARTA_REGISTRADA           = '10138';
    ...
    protected static $services
        = array(
            ...
            self::SERVICE_SEDEX_REVERSO_CONTRATO_AGENCIA_TA => array('SEDEX Reverso Contrato Agência TA', 161274),
            self::SERVICE_PAC_REVERSO_CONTRATO_AGENCIA_TA => array('PAC Reverso Contrato Agência TA', 161277)
        );
