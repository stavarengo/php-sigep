<?php
    ...
    $destinatario->setNome('Rodolfo Milanez');
    ...
    $destinatario->setTelefone('995405366');
    $destinatario->setEmail('william@send4.com.br');

    $remetente = new \PhpSigep\Model\Remetente();
    $remetente->setNome('William Novak`s Home');
    ...
    $remetente->setDdd('41');
    $remetente->setTelefone('995405366');
    $remetente->setDddCelular('41');
    $remetente->setCelular('995405366');
    $remetente->setEmail('william@send4.com.br');
