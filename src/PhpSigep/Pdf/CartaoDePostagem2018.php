			...
			for ($area = 0; $area < 1; $area++) {
				...
				switch ($servicoDePostagem->getCodigo()) {
					...
					case ServicoDePostagem::SERVICE_PAC_CONTRATO_UO:
						$simbolo_de_encaminhamento = realpath(dirname(__FILE__)) . '/simbolo-pac.png';
						$_texto = 'PAC';
						break;
					case ServicoDePostagem::SERVICE_E_SEDEX_STANDARD:
						$simbolo_de_encaminhamento = realpath(dirname(__FILE__)) . '/simbolo-sedex.png';
						$_texto = 'e-SEDEX';
						break;					
					...
					case ServicoDePostagem::SERVICE_SEDEX_12:
						$simbolo_de_encaminhamento = realpath(dirname(__FILE__)) . '/simbolo-sedex2.png';
						$_texto = 'SEDEX 12';
						break;
